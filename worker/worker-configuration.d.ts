/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b3a40ff5db3dd06f0fa83c595e0c2738)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_KEY" | "TMDB_READ_TOKEN">> {}
}
